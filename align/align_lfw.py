...
def main(args):
    ...
    dataset = face_image.get_dataset('webface', args.input_dir)
    print('dataset size', 'webface', len(dataset))
    ...
    output_filename = os.path.join(args.output_dir, 'CASIA-WebFace-Fake-new-align.txt')
...
def parse_arguments():
    ...
    parser.add_argument('--input-dir', type=str, default='./CASIA-WebFace-Fake_0' ,help='Directory with unaligned images.')
    parser.add_argument('--output-dir', type=str,default='./CASIA-WebFace-Fake-new-align' ,help='Directory with aligned face thumbnails.')
